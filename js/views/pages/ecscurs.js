    ...
    render() {
        return new Promise(resolve => {
            ...
            <div class="title-load">
                ...
                <div class="icon"><a href="../../../document/Апрацоўка лёну і ткацтва.docx"><img src="../../../img/icon/ms-word-icon-2048x2026-3u3jf850.png" alt=""></a></div>
            </div>
            <div class="title-load">
                <div class="title-text">
                    <h3>
            ...
            <div class="title-load">
                ...
                <div class="icon"><a href="../../../document/Экскурсія Хатка гаспадара.docx"><img src="../../../img/icon/ms-word-icon-2048x2026-3u3jf850.png" alt=""></a></div>
            </div>
        </div>   
