...
*/
  // Delegate the touch handlers to the widget's element
  $("body").on("touchstart", "#" + this.element.attr("id"), $.proxy(this, '_touchStart'));
  $("body").on("touchmove", "#" + this.element.attr("id"), $.proxy(this, '_touchMove'));
  $("body").on("touchend", "#" + this.element.attr("id"), $.proxy(this, '_touchEnd'));
